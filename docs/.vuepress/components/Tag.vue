...
<template>
    <div v-if="!dynamic" class="m-tag"
        ...
        <span class="m-close" v-if="closable" @click="onClose">
            <svg focusable="false" class="u-close" data-icon="close" width="1em" height="1em" fill="currentColor"
    ...
    <Space v-else :width="spaceWidth" :align="spaceAlign" :direction="spaceDirection" :size="spaceSize">
        ...
        <div v-if="!showInput" class="m-tag" :class="[ `tag-${size}`, { 'm-plus': dynamic } ]" @click="onAdd">
            <svg focusable="false" class="u-plus" data-icon="plus" width="1em" height="1em" fill="currentColor"
                aria-hidden="true" viewBox="64 64 896 896">
                <path d="M482 152h60q8 0 8 8v704q0 8-8 8h-60q-8 0-8-8V160q0-8 8-8z"></path>
                <path d="M176 474h672q8 0 8 8v60q0 8-8 8H176q-8 0-8-8v-60q0-8 8-8z"></path>
            </svg>
        </div>
        <input v-show="showInput" ref="inputRef" class="u-input" :class="`input-${size}`" type="text"
            v-model="inputValue" @blur="showInput = false" @change="onChange" @keydown="onKeyboard" />
    </Space>
</template>
