  ...
  <div v-if="type === 'line'" class="m-progress-line"
    ...
    <div class="m-progress-inner">
      <div :class="['u-progress-bg', { 'u-success-bg': percent >= 100 }]"
        :style="`background: ${lineColor}; width: ${percent >= 100 ? 100 : percent}%; height: ${strokeWidth}px;`"></div>
    </div>
    <template v-if="showInfo">
      <Transition mode="out-in">
        <span v-if="percent >= 100" class="m-success">
          <svg focusable="false" class="u-icon" data-icon="check-circle" width="1em" height="1em" fill="currentColor"
